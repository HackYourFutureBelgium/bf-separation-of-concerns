    ...
    const compareElements = (actual, expected, preface) => {
        ...
        describe(
            ...
            () => {
                ...
                if (expected.tagName === 'CANVAS') {
                    ...
                    if (sameDimensions) {
                        it('should have matching pixels', () => {
                            for (
                                let i = 0;
                                i < expectedImageData.data.length;
                                i++
                            ) {
                                if (
                                    actualImageData.data[i] !==
                                    expectedImageData.data[i]
                                ) {
                ...
                const actualDirectTextContent = Array.from(
                    actual.childNodes,
                ...
                if (
                    ...
                    it(`should have own text - "${expectedDirectTextContent}"`, () => {
                        expect(actualDirectTextContent).to.equal(
                            expectedDirectTextContent,
                        );
                    });
                }
                ...
                if (
                    actualClassList.length !== 0 ||
                    expectedClassList.length !== 0
                ) {
                    ...
                    it(`should have classList members: ${renderedClassListMembers}`, () => {
                        expect(actualClassList).to.have.members(
                            expectedClassList,
                        );
                    });
                }
