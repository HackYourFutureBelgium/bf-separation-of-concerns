        ...
        : !!(91 > e) ||
              (97 > e
                  ...
                  : !!(123 > e) ||
                    (65535 >= e
                        ? 170 <= e &&
                          nonASCIIidentifierStart.test(String.fromCharCode(e))
                        : !1 !== t &&
...
function getOptions(e) {
    ...
    return (
        isArray(t.onComment) && (t.onComment = pushComment(t, t.onComment)), t
    );
}
...
var BIND_NONE = 0,
    ...
    Parser = function (e, t, a) {
        ...
        !0 !== e.allowReserved &&
            ((n =
                reservedWords[
                    6 <= e.ecmaVersion ? 6 : 5 === e.ecmaVersion ? 5 : 3
                ]),
...
(Parser.prototype.parse = function () {
    ...
    (prototypeAccessors.allowSuper.get = function () {
        ...
        return (
            0 < (t & SCOPE_SUPER) || a || this.options.allowSuperOutsideMethod
        );
    }),
...
(pp.strictDirective = function (e) {
    ...
    (pp.isContextual = function (e) {
        return (
            this.type === types.name && this.value === e && !this.containsEsc
        );
    }),
...
(pp$1.isLet = function (e) {
    ...
    if (isIdentifierStart(n, !0)) {
        for (
            var r = a + 1;
            isIdentifierChar((n = this.input.charCodeAt(r)), !0);
    ...
    (pp$1.isAsyncFunction = function () {
        if (8 > this.options.ecmaVersion || !this.isContextual('async'))
            return !1;
        skipWhiteSpace.lastIndex = this.pos;
        var e,
    ...
    (pp$1.parseIfStatement = function (e) {
        return (
            ...
            (e.alternate = this.eat(types._else)
        ...
        if ((this.next(), this.eat(types.parenL))) {
            ...
            this.enterScope(a ? SCOPE_SIMPLE_CATCH : 0),
                this.checkLValPattern(
                    t.param,
                    a ? BIND_SIMPLE_CATCH : BIND_LEXICAL,
                ),
...
(pp$1.parseFunction = function (e, t, a, n) {
    ...
    (pp$1.parseClass = function (e, t) {
        ...
        var n = this.enterClassBody(),
            ...
            s = !1;
        for (
            r.body = [], this.expect(types.braceL);
            this.type !== types.braceR;
    ...
    (pp$1.parseClassSuper = function (e) {
        e.superClass = this.eat(types._extends)
        ...
        if (this.isContextual('await') && this.canAwait)
            ...
            (i.operator = this.value),
                ...
                o
                    ...
                    : 'delete' === i.operator &&
                      isPrivateFieldAccess(i.argument)
                    ? this.raiseRecoverable(
                          i.start,
        ...
        for (
            ...
            if (
                ...
                if (i) {
                    ...
                    (o.expression = r),
                        (r = this.finishNode(o, 'ChainExpression'));
                }
                return r;
            }
            e = r;
    ...
    (pp$3.parseExprList = function (e, t, a, n) {
        for (var r = [], s = !0; !this.eat(e); ) {
            if (!!s) s = !1;
                ...
                (this.expect(types.comma), t && this.afterTrailingComma(e))
            )
                break;
            var i = void 0;
...
(pp$5.enterScope = function (e) {
    ...
    (pp$5.treatFunctionsAsVarInScope = function (e) {
        return (
            e.flags & SCOPE_FUNCTION || (!this.inModule && e.flags & SCOPE_TOP)
        );
    }),
...
(pp$7.initialContext = function () {
    ...
    (pp$7.inGeneratorContext = function () {
        for (var e, t = this.context.length - 1; 1 <= t; t--)
            if (((e = this.context[t]), 'function' === e.token))
                return e.generator;
        return !1;
    }),
    ...
    (types.braceL.updateContext = function (e) {
        this.context.push(
            this.braceIsBlock(e) ? types$1.b_stat : types$1.b_expr,
        ),
            (this.exprAllowed = !0);
    }),
...
(pp$8.validateRegExpFlags = function (e) {
    ...
    (pp$8.regexp_eatSyntaxCharacter = function (e) {
        var t = e.current();
        return (
            !!isSyntaxCharacter(t) && ((e.lastIntValue = t), e.advance(), !0)
        );
    });
...
(pp$8.regexp_eatAtomEscape = function (e) {
    ...
    (pp$8.regexp_eatControlLetter = function (e) {
        var t = e.current();
        return (
            !!isControlLetter(t) && ((e.lastIntValue = t % 32), e.advance(), !0)
        );
    });
...
(pp$8.regexp_eatUnicodePropertyValueExpression = function (e) {
    ...
    (pp$8.regexp_validateUnicodePropertyNameAndValue = function (e, t, a) {
        has(e.unicodeProperties.nonBinary, t) ||
            e.raise('Invalid property name'),
...
function isHexDigit(e) {
    return (
        (48 <= e && 57 >= e) || (65 <= e && 70 >= e) || (97 <= e && 102 >= e)
    );
}
function hexToInt(e) {
    return 65 <= e && 70 >= e
...
(pp$9.next = function (e) {
    ...
    (pp$9.skipBlockComment = function () {
        ...
        if (
            ...
            for (
                var n;
                (n = lineBreakG.exec(this.input)) && n.index < this.pos;
            ...
            switch (e) {
                ...
                default:
                    if (
                        (8 < e && 14 > e) ||
                        (5760 <= e &&
                            nonASCIIwhitespace.test(String.fromCharCode(e)))
                    )
                        ++this.pos;
                    else break loop;
            }
    ...
    (pp$9.readToken_pipe_amp = function (e) {
        ...
        if (t === e) {
            ...
            return this.finishOp(
                124 === e ? types.logicalOR : types.logicalAND,
                2,
            );
        }
        return 61 === t
...
pp$9.readString = function (e) {
    ...
    return (
        (t += this.input.slice(a, this.pos++)),
        this.finishToken(types.string, t)
    );
};
...
(pp$9.tryReadTemplateToken = function () {
    ...
    (pp$9.readTmplToken = function () {
        for (var e = '', t = this.pos; ; ) {
            ...
            if (
                96 === a ||
                (36 === a && 123 === this.input.charCodeAt(this.pos + 1))
            )
    ...
    (pp$9.readWord = function () {
        var e = this.readWord1(),
            t = types.name;
        return (
            this.keywords.test(e) && (t = keywords$1[e]), this.finishToken(t, e)
        );
    });
var version = '8.4.1';
Parser.acorn = {
